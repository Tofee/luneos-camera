...
FocusScope {
    ...
    Item {
        ...
        SequentialAnimation {
            ...
            SequentialAnimation {
                ParallelAnimation {
                    NumberAnimation {target: viewFinderSwitcherScale; property: "xScale"; from: 1.0; to: 0.8; duration: 100 }
                    NumberAnimation {
                ...
                ParallelAnimation {
                    NumberAnimation {target: viewFinderSwitcherScale; property: "xScale"; from: 0.8; to: 1.0; duration: 100 }
                    NumberAnimation {
                        target: viewFinderSwitcherRotation
                        property: "angle"
                        from: 90
    ...
    Component {
         ...
         Dialog {
             ...
             text: StorageLocations.removableStorageLocation && viewFinderOverlay.settings.preferRemovableStorage ?
                   "Replacing your external media, formatting it, or restarting the device might fix the problem." :
